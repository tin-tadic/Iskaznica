...
class UserController extends Controller
{
    ...
    public function addUser(Request $request) {
        ...
        $autoGeneratedPassword = Str::random();
        ...
        // Notify the newly added user via email and send them their autogenerated password
        $details = [
            'body' => 'Prijavite se sa mailom na koji vam je došla ova obavijest, sa lozinkom: ' . $autoGeneratedPassword
        ];
